...
TARGET = "precio"
df_modelo = pd.read_pickle(f"{FILE_DIR}/../../bin/dataframe_ml.pickle")

with open(f"{FILE_DIR}/../../bin/marca_sola_precio_encoder.pickle", "rb") as file:
    marca_sola_precio_encoder = pickle.load(file)

with open(f"{FILE_DIR}/../../bin/min_max_scaler.pickle", "rb") as file:
...
df_resultados.to_pickle(f"{FILE_DIR}/../../bin/resultados_modelos_ml.pickle")
...
with open(f"{FILE_DIR}/../../bin/best_score_ml.pickle", "wb") as file:
...
df_importancias.to_pickle(f"{FILE_DIR}/../../bin/feature_importance.pickle")

with open(f"{FILE_DIR}/../../bin/mejor_modelo.pickle", "wb") as archivo:
